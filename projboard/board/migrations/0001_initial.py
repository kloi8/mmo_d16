    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('tanks', 'Танки'), ('heals', 'Хилы'), ('damage dealers', 'ДД'), ('merchants', 'Торговцы'), ('gild masters', 'Гилдмастеры'), ('questgivers', 'Квестгиверы'), ('blacksmiths', 'Кузнецы'), ('leatherworkers', 'Кожевники'), ('potions makers', 'Зельевары'), ('spell masters', 'Мастера заклинаний')], default='heal', max_length=20)),
